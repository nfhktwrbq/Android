...
public class BluetoothChatService {
	...
	private void connectionFailed() {
		...
		Bundle bundle = new Bundle();
		bundle.putString(MainActivity.TOAST, context.getString(R.string.unable_to_connect_device));
		msg.setData(bundle);
		mHandler.sendMessage(msg);
	...
	private void connectionLost() {
		...
		Message msg = mHandler.obtainMessage(MainActivity.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putString(MainActivity.TOAST, context.getString(R.string.device_connection_was_lost));
		msg.setData(bundle);
		mHandler.sendMessage(msg);
